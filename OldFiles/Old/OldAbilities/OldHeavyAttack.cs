...
{
    //Does heavy damage. That's it.
    Damage damageBehavior = new Damage();
    ...
    public void OnOverwhelm(StatSheet user, StatSheet target)
    {
        ...
        //It does not but it's in the AbilityBehavior interface so it's gotta be here
